                ...
                child: SingleChildScrollView(
                  child: Padding(
                    ...
                    child: Column(children: [
                      ...
                      Text(
                        " AJIJUL HOQUE (Shanto)",style:TextStyle(fontSize: MediaQuery.of(context).size.width/15,color: Colors.black,fontWeight: FontWeight.bold),
                      ),
                      Text("Choose the right momentary taking a photo just after your cat has eaten or naturally woken up.",style:TextStyle(fontSize: MediaQuery.of(context).size.width/18)),
                      AspectRatio(
                        aspectRatio: 16 / 16,
                        child: GridView.builder(
                            scrollDirection: Axis.horizontal,
                            itemCount: MyPhotoGallery_1.length,
                            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                              crossAxisCount: 3,),
                            itemBuilder: (context, index) {
                              return Card(
                                elevation: 10,
                                child: Image.network("${MyPhotoGallery_1[index]["img"]}"),
                              );
                            }),
                      ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              "AJIJUL HOQUE (Shanto)",
                              style: mSizedText(color: Colors.black),
                            ),
                            Text("Choose the right momentry taking a photo just after your cat has eaten or naturally woken up."),
                            Center(
                              child: Container(
                                  child: AspectRatio(
                                    aspectRatio: 16 / 16,
