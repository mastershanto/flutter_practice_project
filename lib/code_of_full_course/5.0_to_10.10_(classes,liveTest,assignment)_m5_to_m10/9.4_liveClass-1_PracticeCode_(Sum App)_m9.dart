...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    MyInputOnChange(InputKey, InputValue) {
      setState(() {
        //this is a formula of adding value into map object;
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Addition Calculator by ostad"),
          centerTitle: true,
        ),
        body: Padding(
            ...
            children: [
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  style: elevatedButtonGeneralStyle(
                      bgColor: Colors.white, context: context ),
                ),
              ),
            ],
          ),
